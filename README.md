...
- **CLI:** `backend/scripts/reindex_arcgis_rest_catalog.py` — same crawl, from the shell (optional `--write-json path.json`).
...
| `.env.example` | Explorer environment variables (copy to `.env` at repo root) |
